...
The protocol overhead is negligible: a full correction round with 8 neighbours takes **~850 ms**, costs **2.81 J** on the requesting satellite, and a no-relay daily operating tempo remains **~0.203% of a 5 W onboard energy budget**.
